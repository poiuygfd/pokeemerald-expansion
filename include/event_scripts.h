...
extern const u8 EventScript_UseHatchetCut[];
extern const u8 EventScript_UseRockSmash[];
extern const u8 EventScript_UsePickaxeSmash[];
...
extern const u8 EventScript_EarbudsChooseMusic[];
...
extern const u8 EventScript_UseBrineysKeys[];
extern const u8 EventScript_BrineyIsSteering[];
extern const u8 EventScript_MoveBrineyRoute104[];
extern const u8 EventScript_MoveBrineyDewfordTown[];
extern const u8 EventScript_MoveBrineyRoute109[];
...
extern const u8 FortreeCity_EventScript_ScottWonAtFortreeGymCall[];
