...
extern const u8 gText_MenuOptionDexnav[];
...
extern const u8 gText_PkmnChangedLeader[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ShellBellDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AbilityShieldDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlunderPolicyDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LightClayDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TerrainExtenderDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WooperDollDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LotadDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SeedotDollDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_Porygon2DollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LaprasDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SnorlaxDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_VenusaurDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CharizardDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BlastoiseDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RegirockDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RegiceDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_RegisteelDollDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_EverstoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_EvoItemDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MegaStoneDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_IceFangDesc[];
extern const u8 BattleFrontier_Lounge7_Text_ThunderFangDesc[];
extern const u8 BattleFrontier_Lounge7_Text_FireFangDesc[];
extern const u8 BattleFrontier_Lounge7_Text_SignalBeamDesc[];
extern const u8 BattleFrontier_Lounge7_Text_PsychUpDesc[];
extern const u8 BattleFrontier_Lounge7_Text_AuroraVeilDesc[];
extern const u8 BattleFrontier_Lounge7_Text_BulldozeDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_LiquidationDesc[];
extern const u8 BattleFrontier_Lounge7_Text_MeteorBeamDesc[];
extern const u8 BattleFrontier_Lounge7_Text_TripleAxelDesc[];
extern const u8 BattleFrontier_Lounge7_Text_SplishySplashDesc[];
extern const u8 BattleFrontier_Lounge7_Text_FloatyFallDesc[];
extern const u8 BattleFrontier_Lounge7_Text_BouncyBubbleDesc[];
extern const u8 BattleFrontier_Lounge7_Text_BuzzyBuzzDesc[];
extern const u8 BattleFrontier_Lounge7_Text_DescSizzlySlide[];
extern const u8 BattleFrontier_Lounge7_Text_GlitzyGlowDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_VeeveeVolleyDesc[];
