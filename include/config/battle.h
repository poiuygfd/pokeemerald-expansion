...
#define B_BATTLE_BOND                   GEN_7      // In Gen9+, Battle Bond raises Attack, Sp. Atk, and Speed by 1 stage, once per battle. Previously, the Pokémon would change into Ash-Greninja.
...
// Badge boost flags
#define B_FLAG_BADGE_BOOST_ATTACK   FLAG_BADGE02_GET // If this flag is set and B_BADGE_BOOST == GEN_3, it will increase the Attack of the player's Pokémon.
...
#define B_VAR_NO_BAG_USE         VAR_PREVENT_BAG_USE     // If set to 1, the ability to use the Bag is disabled in Trainer battles. If set to 2, it is also disabled in wild battles.
