...
enum StringID
{
    ...
    STRINGID_ANTIVIRUSSTART,
    STRINGID_ANTIVIRUSSTOP,
    STRINGID_ANTIVIRUSPROTECT,
    STRINGID_PKMNISENRAGED,
    ...
    STRINGID_REACTEDTOSUPEREFFECTIVE,
    STRINGID_NEPOTISMPRESENCEOFMONEY,
    STRINGID_NEPOTISMTRANSFORM,
    ...
    STRINGID_THEVOIDCREEPSIN,
    STRINGID_THEVOIDENDS,
    STRINGID_PKMNCONSUMEDBYDARKNESS,
    STRINGID_COUNT
};
...
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_VOID + 1),
