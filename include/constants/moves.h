...
enum __attribute__((packed)) Move
{
    ...
    MOVE_FLASH_FREEZE = 850,
    MOVE_BEAN_BEAM = 851,
    MOVE_LEADER_SWAP = 852,
    // Dark Magikarp Moves
    MOVE_VENGEANCE = 853,
    MOVE_ABYSSAL_RUSH = 854,
    MOVE_DEPTH_CRUSHER = 855,
    MOVE_DARKNESS_DIVE = 856,
    MOVE_MARINA_VORTEX = 857,
    MOVE_SUFFER_STRIKE = 858,
    MOVES_COUNT,
