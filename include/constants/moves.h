...
enum __attribute__((packed)) Move
{
    ...
    MOVE_SPECIAL_DELIVERY = 850,
    MOVE_FLORAL_DELIVERY = 851,
    MOVE_INFERNAL_DELIVERY = 852,
    MOVE_AQUATIC_DELIVERY = 853,
    MOVE_DIGITAL_DELIVERY = 854,
    MOVE_VENOMOUS_DELIVERY = 855,
    MOVE_FALCON_DELIVERY = 856,
    MOVE_MINDFUL_DELIVERY = 857,
    MOVE_EARTHEN_DELIVERY = 858,
    MOVE_FLASH_FREEZE = 859,
    MOVE_LA_HIDDEN_POWER = 860,
    MOVE_BEAN_BEAM = 861,
    MOVE_LEADER_SWAP = 862,
    // Dark Magikarp Moves
    MOVE_VENGEANCE = 863,
    MOVE_ABYSSAL_RUSH = 864,
    MOVE_DEPTH_CRUSHER = 865,
    MOVE_DARKNESS_DIVE = 866,
    MOVE_MARINA_VORTEX = 867,
    MOVE_SUFFER_STRIKE = 868,
    MOVES_COUNT,
