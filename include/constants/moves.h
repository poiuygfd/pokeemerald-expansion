...
enum __attribute__((packed)) Move
{
    ...
    MOVE_FLASH_FREEZE = 851,
    MOVE_BEAN_BEAM = 852,
    MOVE_LEADER_SWAP = 853,
    // Dark Magikarp Moves
    MOVE_VENGEANCE = 854,
    MOVE_ABYSSAL_RUSH = 855,
    MOVE_DEPTH_CRUSHER = 856,
    MOVE_DARKNESS_DIVE = 857,
    MOVE_MARINA_VORTEX = 858,
    MOVE_SUFFER_STRIKE = 859,
    MOVES_COUNT,
