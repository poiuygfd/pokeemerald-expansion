...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_AVITORCH,
    NATIONAL_DEX_REGITUBE,
    NATIONAL_DEX_PARTRIO,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_REGITUBE
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_IMPIDIMP,
    HOENN_DEX_MORGREM,
    HOENN_DEX_GRIMMSNARL,
    HOENN_DEX_GREAVARD,
    HOENN_DEX_HOUNDSTONE,
    HOENN_DEX_LITWICK,
    HOENN_DEX_LAMPENT,
...
enum KantoDexOrder
{
    ...
    KANTO_DEX_SHIINOTIC,
    KANTO_DEX_FERROSEED,
    KANTO_DEX_FERROTHORN,
    KANTO_DEX_CLEFFA,
    KANTO_DEX_CLEFAIRY,
    KANTO_DEX_CLEFABLE,
    KANTO_DEX_ROOKIDEE,
    KANTO_DEX_CORVISQUIRE,
    KANTO_DEX_CORVIKNIGHT,
    KANTO_DEX_EKANS,
    KANTO_DEX_ARBOK,
    KANTO_DEX_SALANDIT,
    KANTO_DEX_SALAZZLE,
    ...
    KANTO_DEX_GENGAR,
    KANTO_DEX_SINISTEA,
    KANTO_DEX_POLTEAGEIST,
    KANTO_DEX_GOTHITA,
    KANTO_DEX_GOTHORITA,
    KANTO_DEX_GOTHITELLE,
    KANTO_DEX_IMPIDIMP,
    KANTO_DEX_MORGREM,
    KANTO_DEX_GRIMMSNARL,
    KANTO_DEX_CUBONE,
    KANTO_DEX_MAROWAK,
    KANTO_DEX_LITWICK,
    KANTO_DEX_LAMPENT,
    KANTO_DEX_CHANDELURE,
    KANTO_DEX_SIGILYPH,
    KANTO_DEX_SMOLIV,
    KANTO_DEX_DOLLIV,
    KANTO_DEX_ARBOLIVA,
    ...
    KANTO_DEX_VENOMOTH,
    KANTO_DEX_TOXEL,
    KANTO_DEX_TOXTRICITY,
    KANTO_DEX_FARFETCHD,
    KANTO_DEX_SIRFETCHD,
    KANTO_DEX_AUDINO,
    KANTO_DEX_VENIPEDE,
    KANTO_DEX_WHIRLIPEDE,
    KANTO_DEX_SCOLIPEDE,
    KANTO_DEX_WIMPOD,
    KANTO_DEX_GOLISOPOD,
    KANTO_DEX_DITTO,
    ...
    KANTO_DEX_WIGLETT,
    KANTO_DEX_WUGTRIO,
    KANTO_DEX_POLTCHAGEIST,
    KANTO_DEX_SINISTCHA,
    KANTO_DEX_TOEDSCOOL,
    KANTO_DEX_TOEDSCRUEL,
    KANTO_DEX_MAGNEMITE,
    KANTO_DEX_MAGNETON,
    KANTO_DEX_MAGNEZONE,
    KANTO_DEX_VOLTORB,
...
#define HOENN_DEX_COUNT (HOENN_DEX_PARTRIO + 1)
