...
enum
{
    ...
    MULTI_HILL_CHOOSE_MODE,
    MULTI_HILL_EXPLAIN_MODE,
    MULTI_GALARICA_ITEM,
    MULTI_GAME_CORNER_GIMMIGHOUL,
    MULTI_PLEDGE_MOVES,
    MULTI_ULTIMATE_MOVES,
    MULTI_DEPTHS_CHOOSE_MODE,
    MULTI_DEPTHS_EXPLAIN_MODE,
    MULTI_PASS_CHOICE,
    MULTI_STEAL_BUCKET,
    MULTI_NOTEBOOK_PAGES,
    MULTI_MUSIC_SELECTION,
...
#define STDSTRING_MEDICINE         19
#define STDSTRING_MEGASTONES       20
...
#define STDSTRING_BOULDER_BADGE    32
#define STDSTRING_CASCADE_BADGE    33
#define STDSTRING_THUNDER_BADGE    34
#define STDSTRING_RAINBOW_BADGE    35
#define STDSTRING_SOUL_BADGE       36
#define STDSTRING_MARSH_BADGE      37
#define STDSTRING_VOLCANO_BADGE    38
#define STDSTRING_EARTH_BADGE      39
#define STDSTRING_COINS            40
