...
enum __attribute__((packed)) Item
{
    ...
    // New Hold Items
    ITEM_TOUGH_BUCKET = 876,

    // New Key Items
    ITEM_CANDY_BAG = 877,
    ITEM_ULTRA_BIKE = 878,
    ITEM_COSTUME_CASE = 879,
    ITEM_BATTLE_PASS = 880,
    ITEM_HI_TECH_EARBUDS = 881,
    ITEM_OUTFIT_BOX = 882,
    ITEM_POKEVIAL = 883,
    ...
    ITEM_HATCHET = 884,
    ITEM_EON_FLUTE = 885,
    ITEM_BRINEYS_KEYS = 886,
    ITEM_POWER_GLOVES = 887,
    ITEM_FLASHLIGHT = 888,
    ITEM_PICKAXE = 889,
    ITEM_KOI_CHARM = 890,
    ITEM_SCUBA_GEAR = 891,
    ITEM_CLIMBING_GEAR = 892,
    ITEM_HM10_REPLACE = 893,

    //New Mega Stones
    ITEM_SLOWBRONITE_G = 894,
    ITEM_CASTFORMITE = 895,
    ITEM_HYDREIGONITE = 896,
    ITEM_TSAREENITE = 897,
    ITEM_KLEAVORITE = 898,
    ITEM_FLAMIGONITE = 899,
    ITEM_LUMINEONITE = 900,
    ITEM_CHARIZARDITE_Z = 901,

    //it comes for us all
    ITEM_ABYSS_STONE = 902,
