...
enum __attribute__((packed)) Item
{
    ...
    ITEM_HATCHET = 880,
    ITEM_EON_FLUTE = 881,
    ITEM_BRINEYS_KEYS = 882,
    ITEM_POWER_GLOVES = 883,
    ITEM_FLASHLIGHT = 884,
    ITEM_PICKAXE = 885,
    ITEM_KOI_CHARM = 886,
    ITEM_SCUBA_GEAR = 887,
    ITEM_CLIMBING_GEAR = 888,
    ITEM_HM10_REPLACE = 889,

    //New Mega Stones
    ITEM_SLOWBRONITE_G = 890,
    ITEM_CASTFORMITE = 891,
    ITEM_HYDREIGONITE = 892,
    TEM_CHARIZARDITE_Z = 893,
