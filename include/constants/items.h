...
enum __attribute__((packed)) Item
{
    ...
    // New Items
    ITEM_CANDY_BAG = 874,
    ITEM_COSTUME_CASE = 875,
    ITEM_BATTLE_PASS = 876,
    ITEM_OUTFIT_BOX = 877,

    //HM Replacement Items
    ITEM_HATCHET = 878,
    ITEM_EON_FLUTE = 879,
    ITEM_BRINEYS_KEYS = 880,
    ITEM_POWER_GLOVES = 881,
    ITEM_FLASHLIGHT = 882,
    ITEM_PICKAXE = 883,
    ITEM_KOI_CHARM = 884,
    ITEM_SCUBA_GEAR = 885,
    ITEM_CLIMBING_GEAR = 886,
    ITEM_HM10_REPLACE = 887,

    //New Mega Stones
    ITEM_SLOWBRONITE_G = 888,
    ITEM_CASTFORMITE = 889,
    ITEM_HYDREIGONITE = 890,
    TEM_CHARIZARDITE_Z = 891,
