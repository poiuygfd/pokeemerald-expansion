...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 692,
    ITEM_SHINY_CHARM = 693,
    ITEM_CATCHING_CHARM = 694,
    ITEM_EXP_CHARM = 695,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 696,
    ITEM_GRACIDEA = 697,
    ITEM_REVEAL_GLASS = 698,
    ITEM_DNA_SPLICERS = 699,
    ITEM_ZYGARDE_CUBE = 700,
    ITEM_PRISON_BOTTLE = 701,
    ITEM_N_SOLARIZER = 702,
    ITEM_N_LUNARIZER = 703,
    ITEM_REINS_OF_UNITY = 704,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 705,
    ITEM_Z_POWER_RING = 706,
    ITEM_DYNAMAX_BAND = 707,
    ...
    ITEM_GOOD_ROD = 712,
    ITEM_SUPER_ROD = 713,
    ITEM_DOWSING_MACHINE = 714,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 715,
    ITEM_VS_SEEKER = 716,
    ITEM_TM_CASE = 717,
    ITEM_BERRY_POUCH = 718,
    ITEM_POKEMON_BOX_LINK = 719,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 720,
    ITEM_POWDER_JAR = 721,
    ITEM_WAILMER_PAIL = 722,
    ITEM_POKE_RADAR = 723,
    ITEM_POKEBLOCK_CASE = 724,
    ITEM_SOOT_SACK = 725,
    ITEM_POKE_FLUTE = 726,
    ITEM_FAME_CHECKER = 727,
    ITEM_TEACHY_TV = 728,

    // Story Key Items
    ITEM_SS_TICKET = 729,
    ITEM_EON_TICKET = 730,
    ITEM_MYSTIC_TICKET = 731,
    ITEM_AURORA_TICKET = 732,
    ITEM_OLD_SEA_MAP = 733,
    ITEM_LETTER = 734,
    ITEM_DEVON_PARTS = 735,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 736,
    ITEM_DEVON_SCOPE = 737,
    ITEM_BASEMENT_KEY = 738,
    ITEM_SCANNER = 739,
    ITEM_STORAGE_KEY = 740,
    ITEM_KEY_TO_ROOM_1 = 741,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 742,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 743,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 744,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 745,
    ITEM_MAGMA_EMBLEM = 746,
    ITEM_CONTEST_PASS = 747,
    ITEM_PARCEL = 748,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_SECRET_KEY = 749,
    ITEM_BIKE_VOUCHER = 750,
    ITEM_GOLD_TEETH = 751,
    ITEM_CARD_KEY = 752,
    ITEM_LIFT_KEY = 753,
    ITEM_SILPH_SCOPE = 754,
    ITEM_TRI_PASS = 755,
    ITEM_RAINBOW_PASS = 756,
    ITEM_TEA = 757,
    ITEM_RUBY = 758,
    ITEM_SAPPHIRE = 759,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 760,
    ITEM_CLEAR_AMULET = 761,
    ITEM_PUNCHING_GLOVE = 762,
    ITEM_COVERT_CLOAK = 763,
    ITEM_LOADED_DICE = 764,
    ITEM_AUSPICIOUS_ARMOR = 765,
    ITEM_BOOSTER_ENERGY = 766,
    ITEM_BIG_BAMBOO_SHOOT = 767,
    ITEM_GIMMIGHOUL_COIN = 768,
    ITEM_LEADERS_CREST = 769,
    ITEM_MALICIOUS_ARMOR = 770,
    ITEM_MIRROR_HERB = 771,
    ITEM_SCROLL_OF_DARKNESS = 772,
    ITEM_SCROLL_OF_WATERS = 773,
    ITEM_TERA_ORB = 774,
    ITEM_TINY_BAMBOO_SHOOT = 775,

    ITEM_BUG_TERA_SHARD = 776,
    ITEM_DARK_TERA_SHARD = 777,
    ITEM_DRAGON_TERA_SHARD = 778,
    ITEM_ELECTRIC_TERA_SHARD = 779,
    ITEM_FAIRY_TERA_SHARD = 780,
    ITEM_FIGHTING_TERA_SHARD = 781,
    ITEM_FIRE_TERA_SHARD = 782,
    ITEM_FLYING_TERA_SHARD = 783,
    ITEM_GHOST_TERA_SHARD = 784,
    ITEM_GRASS_TERA_SHARD = 785,
    ITEM_GROUND_TERA_SHARD = 786,
    ITEM_ICE_TERA_SHARD = 787,
    ITEM_NORMAL_TERA_SHARD = 788,
    ITEM_POISON_TERA_SHARD = 789,
    ITEM_PSYCHIC_TERA_SHARD = 790,
    ITEM_ROCK_TERA_SHARD = 791,
    ITEM_STEEL_TERA_SHARD = 792,
    ITEM_WATER_TERA_SHARD = 793,

    ITEM_ADAMANT_CRYSTAL = 794,
    ITEM_GRISEOUS_CORE = 795,
    ITEM_LUSTROUS_GLOBE = 796,

    ITEM_BLACK_AUGURITE = 797,
    ITEM_LINKING_CORD = 798,
    ITEM_PEAT_BLOCK = 799,
    ITEM_BERSERK_GENE = 800,

    ITEM_FAIRY_FEATHER = 801,
    ITEM_SYRUPY_APPLE = 802,
    ITEM_UNREMARKABLE_TEACUP = 803,
    ITEM_MASTERPIECE_TEACUP = 804,
    ITEM_CORNERSTONE_MASK = 805,
    ITEM_WELLSPRING_MASK = 806,
    ITEM_HEARTHFLAME_MASK = 807,
    ITEM_HEALTH_MOCHI = 808,
    ITEM_MUSCLE_MOCHI = 809,
    ITEM_RESIST_MOCHI = 810,
    ITEM_GENIUS_MOCHI = 811,
    ITEM_CLEVER_MOCHI = 812,
    ITEM_SWIFT_MOCHI = 813,
    ITEM_FRESH_START_MOCHI = 814,
    ITEM_GLIMMERING_CHARM = 815,
    ITEM_METAL_ALLOY = 816,
    ITEM_STELLAR_TERA_SHARD = 817,

    ITEM_JUBILIFE_MUFFIN = 818,
    ITEM_REMEDY = 819,
    ITEM_FINE_REMEDY = 820,
    ITEM_SUPERB_REMEDY = 821,
    ITEM_AUX_EVASION = 822,
    ITEM_AUX_GUARD = 823,
    ITEM_AUX_POWER = 824,
    ITEM_AUX_POWERGUARD = 825,
    ITEM_CHOICE_DUMPLING = 826,
    ITEM_SWAP_SNACK = 827,
    ITEM_TWICE_SPICED_RADISH = 828,
    ITEM_POKESHI_DOLL = 829,

    ITEM_STRANGE_BALL = 830,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 831,
    ITEM_VICTREEBELITE = 832,
    ITEM_STARMINITE = 833,
    ITEM_DRAGONINITE = 834,
    ITEM_MEGANIUMITE = 835,
    ITEM_FERALIGITE = 836,
    ITEM_SKARMORITE = 837,
    ITEM_FROSLASSITE = 838,
    ITEM_EMBOARITE = 839,
    ITEM_EXCADRITE = 840,
    ITEM_SCOLIPITE = 841,
    ITEM_SCRAFTINITE = 842,
    ITEM_EELEKTROSSITE = 843,
    ITEM_CHANDELURITE = 844,
    ITEM_CHESNAUGHTITE = 845,
    ITEM_DELPHOXITE = 846,
    ITEM_GRENINJITE = 847,
    ITEM_PYROARITE = 848,
    ITEM_FLOETTITE = 849,
    ITEM_MALAMARITE = 850,
    ITEM_BARBARACITE = 851,
    ITEM_DRAGALGITE = 852,
    ITEM_HAWLUCHANITE = 853,
    ITEM_ZYGARDITE = 854,
    ITEM_DRAMPANITE = 855,
    ITEM_FALINKSITE = 856,
    ...
    ITEM_DARKRANITE = 858,
    ITEM_ZERAORITE = 859,
    ITEM_RAICHUNITE_X = 860,
    ITEM_RAICHUNITE_Y = 861,
    ITEM_CHIMECHITE = 862,
    ITEM_ABSOLITE_Z = 863,
    ITEM_STARAPTITE = 864,
    ITEM_GARCHOMPITE_Z = 865,
    ITEM_LUCARIONITE_Z = 866,
    ITEM_GOLURKITE = 867,
    ITEM_MEOWSTICITE = 868,
    ITEM_CRABOMINITE = 869,
    ITEM_GOLISOPITE = 870,
    ITEM_MAGEARNITE = 871,
    ITEM_SCOVILLAINITE = 872,
    ITEM_BAXCALIBRITE = 873,
    ITEM_TATSUGIRINITE = 874,
    ITEM_GLIMMORANITE = 875,

    // New Items
    ITEM_CANDY_BAG = 876,
    ITEM_COSTUME_CASE = 877,
    ITEM_BATTLE_PASS = 878,
    ITEM_HI_TECH_EARBUDS = 879,
    ITEM_OUTFIT_BOX = 880,

    //HM Replacement Items
    ITEM_HATCHET = 881,
    ITEM_EON_FLUTE = 882,
    ITEM_BRINEYS_KEYS = 883,
    ITEM_POWER_GLOVES = 884,
    ITEM_FLASHLIGHT = 885,
    ITEM_PICKAXE = 886,
    ITEM_KOI_CHARM = 887,
    ITEM_SCUBA_GEAR = 888,
    ITEM_CLIMBING_GEAR = 889,
    ITEM_HM10_REPLACE = 890,

    //New Mega Stones
    ITEM_SLOWBRONITE_G = 891,
    ITEM_CASTFORMITE = 892,
    ITEM_HYDREIGONITE = 893,
    ITEM_CHARIZARDITE_Z = 894,
