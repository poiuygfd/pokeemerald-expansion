...
enum __attribute__((packed)) Item
{
    ...
    // New Key Items
    ITEM_CANDY_BAG = 877,
    ITEM_COSTUME_CASE = 878,
    ITEM_BATTLE_PASS = 879,
    ITEM_HI_TECH_EARBUDS = 880,
    ITEM_OUTFIT_BOX = 881,
    ITEM_POKEVIAL = 882,
    ...
    ITEM_HATCHET = 883,
    ITEM_EON_FLUTE = 884,
    ITEM_BRINEYS_KEYS = 885,
    ITEM_POWER_GLOVES = 886,
    ITEM_FLASHLIGHT = 887,
    ITEM_PICKAXE = 888,
    ITEM_KOI_CHARM = 889,
    ITEM_SCUBA_GEAR = 890,
    ITEM_CLIMBING_GEAR = 891,
    ITEM_HM10_REPLACE = 892,

    //New Mega Stones
    ITEM_SLOWBRONITE_G = 893,
    ITEM_CASTFORMITE = 894,
    ITEM_HYDREIGONITE = 895,
    ITEM_TSAREENITE = 896,
    ITEM_CHARIZARDITE_Z = 897,

    //it comes for us all
    ITEM_ABYSS_STONE = 898,
