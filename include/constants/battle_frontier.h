...
#define EXCHANGE_CORNER_HOLD_ITEM_CLERK  0
#define EXCHANGE_CORNER_DECOR_CLERK      1
#define EXCHANGE_CORNER_EVOLUTION_CLERK  2
#define EXCHANGE_CORNER_MEGA_STONE_CLERK 3
