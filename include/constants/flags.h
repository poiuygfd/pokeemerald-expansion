...
#define FLAG_EXP_SHARE_TOGGLE  0x264 // Exp Share Flag
#define FLAG_DEFEATED_ARTISAN_CAVE_LEAF  0x265 // Leaf Battle
...
#define FLAG_HIDE_OLDALE_TOWN_MARIN_GIFT                            0x2D9 // Hide Marin Gift Giver
