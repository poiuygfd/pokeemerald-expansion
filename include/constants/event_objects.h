...
enum
{
    ...
    OBJ_EVENT_GFX_LUGIA,
    OBJ_EVENT_GFX_HOOH,
    OBJ_EVENT_GFX_LINK_E_BRENDAN,
    OBJ_EVENT_GFX_LINK_E_MAY,
    OBJ_EVENT_GFX_POKE_BALL,
    OBJ_EVENT_GFX_OW_MON,
    OBJ_EVENT_GFX_LIGHT_SPRITE,
    OBJ_EVENT_GFX_VOID_ALTAR,
    OBJ_EVENT_GFX_APRICORN_TREE,
    OBJ_EVENT_GFX_RS_BRENDAN_ACRO_BIKE,
    OBJ_EVENT_GFX_RS_MAY_ACRO_BIKE,
    OBJ_EVENT_GFX_E_BRENDAN_ACRO_BIKE,
    OBJ_EVENT_GFX_E_MAY_ACRO_BIKE,
    OBJ_EVENT_GFX_RS_BRENDAN_SURFING,
    OBJ_EVENT_GFX_RS_MAY_SURFING,
    OBJ_EVENT_GFX_E_BRENDAN_SURFING,
    OBJ_EVENT_GFX_E_MAY_SURFING,
    OBJ_EVENT_GFX_RS_BRENDAN_FIELD_MOVE,
    OBJ_EVENT_GFX_RS_MAY_FIELD_MOVE,
    OBJ_EVENT_GFX_E_BRENDAN_FIELD_MOVE,
    OBJ_EVENT_GFX_E_MAY_FIELD_MOVE,
    OBJ_EVENT_GFX_RS_BRENDAN_UNDERWATER,
    OBJ_EVENT_GFX_RS_MAY_UNDERWATER,
    OBJ_EVENT_GFX_E_BRENDAN_UNDERWATER,
    OBJ_EVENT_GFX_E_MAY_UNDERWATER,
    OBJ_EVENT_GFX_RS_BRENDAN_FISHING,
    OBJ_EVENT_GFX_RS_MAY_FISHING,
    OBJ_EVENT_GFX_E_BRENDAN_FISHING,
    OBJ_EVENT_GFX_E_MAY_FISHING,
    OBJ_EVENT_GFX_RS_BRENDAN_WATERING,
    OBJ_EVENT_GFX_RS_MAY_WATERING,
    OBJ_EVENT_GFX_E_BRENDAN_WATERING,
    OBJ_EVENT_GFX_E_MAY_WATERING,
    OBJ_EVENT_GFX_RS_BRENDAN_DECORATING,
    OBJ_EVENT_GFX_RS_MAY_DECORATING,
    OBJ_EVENT_GFX_E_BRENDAN_DECORATING,
    OBJ_EVENT_GFX_E_MAY_DECORATING,
