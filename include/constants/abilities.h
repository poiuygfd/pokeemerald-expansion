...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_ANTIVIRUS = 319,
    ABILITY_BUOYANT_POWER = 320,
    ABILITY_CARDBOARD_SHIELD = 321,
    ABILITY_PUNISHER = 322,
    ABILITY_TAG_TEAM = 323,
    ABILITY_REACTIVE_FIRE = 324,
    ABILITY_WEATHERMAN = 325,
    ABILITY_FAE_HUNTER = 326,
    ABILITY_IRON_THIGHS = 327,
    ABILITY_NEPOTISM = 328,
    ABILITY_ABYSSAL_FLOOD = 329,
