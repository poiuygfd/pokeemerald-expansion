...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_PUNISHER = 320,
    ABILITY_TAG_TEAM = 321,
    ABILITY_BUOYANT_POWER = 322,
    ABILITY_REACTIVE_FIRE = 323,
    ABILITY_WEATHERMAN = 324,
    ABILITY_FAE_HUNTER = 325,
    ABILITY_IRON_THIGHS = 326,
    ABILITY_NEPOTISM = 327,
    ABILITY_ABYSSAL_FLOOD = 328,
