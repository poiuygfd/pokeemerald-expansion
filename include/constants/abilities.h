...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_ANTIVIRUS = 311,
    ABILITY_PUNISHER = 312,
    ABILITY_BUOYANT_POWER = 313,
    ABILITY_REACTIVE_FIRE = 314,
    ABILITY_WEATHERMAN = 315,
    ABILITY_FAE_HUNTER = 316,
    ABILITY_NEPOTISM = 317,
