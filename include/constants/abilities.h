...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_ANTIVIRUS = 320,
    ABILITY_BUOYANT_POWER = 321,
    ABILITY_DELIVER = 322,
    ABILITY_PUNISHER = 323,
    ABILITY_TAG_TEAM = 324,
    ABILITY_REACTIVE_FIRE = 325,
    ABILITY_WEATHERMAN = 326,
    ABILITY_FAE_HUNTER = 327,
    ABILITY_IRON_THIGHS = 328,
    ABILITY_OCEAN_BREEZE = 329,
    ABILITY_NEPOTISM = 330,
    ABILITY_ABYSSAL_FLOOD = 331,
