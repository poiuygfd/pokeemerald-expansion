...
#define MOVE_RESULT_ANTIVIRUS_BLOCKED      (1 << 12)
#define MOVE_RESULT_ATTEMPT_STAT_CHANGE    (1 << 13)
#define MOVE_RESULT_STAT_CHANGE_PREVENTED  (1 << 14)
#define MOVE_RESULT_MIRROR_ARMOR_PENDING   (1 << 15)
#define MOVE_RESULT_STAT_CHANGED           (1 << 16)
#define MOVE_RESULT_PROTECTED              (1 << 17)
#define MOVE_RESULT_EXTREMELY_EFFECTIVE    (1 << 18)
#define MOVE_RESULT_MOSTLY_INEFFECTIVE     (1 << 19)
#define MOVE_RESULT_NOT_PRESENT            (1 << 20) // Battler not present at the start of move resolution
