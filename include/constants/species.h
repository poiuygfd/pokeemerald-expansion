...
enum __attribute__((packed)) Species
{
    ...
    // New Species
    SPECIES_MARIN = 1573,
    SPECIES_MISSINGNO = 1574,
    SPECIES_REGITUBE = 1575,
    SPECIES_BOXIMP = 1576,
    SPECIES_AVITORCH_CALM = 1577,
    SPECIES_AVITORCH = SPECIES_AVITORCH_CALM,
    SPECIES_AVITORCH_ENRAGED = 1578,
    SPECIES_PARTRIO_PALADIN = 1579,
    SPECIES_PARTRIO = SPECIES_PARTRIO_PALADIN,
    SPECIES_PARTRIO_WARRIOR = 1580,
    SPECIES_PARTRIO_MAGE = 1581,
    // New forms for existing species
    SPECIES_ROTOM_STEREO = 1582,
    SPECIES_SLOWBRO_MEGA_G = 1583,
    SPECIES_CASTFORM_MEGA = 1584,
    SPECIES_CASTFORM_MEGA_SUNNY = 1585,
    SPECIES_CASTFORM_MEGA_RAINY = 1586,
    SPECIES_CASTFORM_MEGA_SNOWY = 1587,
    SPECIES_HYDREIGON_MEGA = 1588,
    SPECIES_TSAREENA_MEGA = 1589,
    SPECIES_KLEAVOR_MEGA = 1590,
    SPECIES_LUMINEON_MEGA = 1591,
    SPECIES_CHARIZARD_MEGA_Z = 1592,
    SPECIES_CHARIZARD_OMEGA_Z = 1593,
    SPECIES_MAGIKARP_DARK = 1594,
