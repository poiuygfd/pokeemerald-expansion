...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_ROTOM_STEREO = 1575,
    SPECIES_AVITORCH_CALM = 1576,
    SPECIES_AVITORCH = SPECIES_AVITORCH_CALM,
    SPECIES_AVITORCH_ENRAGED = 1577,
    SPECIES_PARTRIO_PALADIN = 1578,
    SPECIES_PARTRIO = SPECIES_PARTRIO_PALADIN,
    SPECIES_PARTRIO_WARRIOR = 1579,
    SPECIES_PARTRIO_MAGE = 1580,
    SPECIES_REGITUBE = 1581,
    SPECIES_SLOWBRO_MEGA_G = 1582,
    SPECIES_CASTFORM_MEGA = 1583,
    SPECIES_CASTFORM_MEGA_SUNNY = 1584,
    SPECIES_CASTFORM_MEGA_RAINY = 1585,
    SPECIES_CASTFORM_MEGA_SNOWY = 1586,
    SPECIES_HYDREIGON_MEGA = 1587,
    SPECIES_TSAREENA_MEGA = 1588,
    SPECIES_CHARIZARD_MEGA_Z = 1589,
    SPECIES_CHARIZARD_OMEGA_Z = 1590,
    SPECIES_MAGIKARP_DARK = 1591,
