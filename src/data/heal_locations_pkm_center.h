...
static const struct HealLocation sHealLocationsPokemonCenter[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_TUFFNOOK_TOWN - 1] =
    {
        .mapGroup = MAP_GROUP(MAP_TUFFNOOK_TOWN_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_TUFFNOOK_TOWN_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
...
static const u8 sHealNpcLocalId[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_TUFFNOOK_TOWN - 1] = 1,
};
