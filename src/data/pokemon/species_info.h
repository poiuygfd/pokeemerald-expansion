...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_MISSINGNO] =
    {
        ...
        .abilities = { ABILITY_ANTIVIRUS, ABILITY_NONE, ABILITY_DOWNLOAD },
    ...
    [SPECIES_PARTRIO_PALADIN] =
    {
        ...
        .cryId = CRY_PARTRIO_PALADIN,
        .natDexNum = NATIONAL_DEX_PARTRIO,
        .categoryName = _("Teamwork"),
        .height = 10,
        .weight = 240,
        .description = COMPOUND_STRING(
            "The three are weak when alone, so they\n"
            "overcome stronger threats with teamwork.\n"
            "The Paladin of Partrio focuses on defense,\n"
            "blocking attacks with its large ears."),
        .pokemonScale = 272,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PartrioPaladin,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_PartrioPaladin,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 13,
    ...
    [SPECIES_PARTRIO_WARRIOR] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PartrioWarrior,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_PartrioWarrior,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Partrio,
    ...
    [SPECIES_PARTRIO_MAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The three are weak when alone, so they\n"
            "overcome stronger threats with teamwork.\n"
            "The Mage of Partrio uses its magic to blast\n"
            "opponents with a barrage of psychic energy."),
        .pokemonScale = 272,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PartrioMage,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 10,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_PartrioMage,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 13,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_Partrio,
    ...
    [SPECIES_LUMINEON_MEGA] =
    {
        ...
        .abilities = { ABILITY_OCEAN_BREEZE, ABILITY_OCEAN_BREEZE, ABILITY_OCEAN_BREEZE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 8,
        .backPic = gMonBackPic_LumineonMega,
        .backPicSize = MON_COORDS_SIZE(56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = gMonPalette_LumineonMega,
        .shinyPalette = gMonShinyPalette_LumineonMega,
