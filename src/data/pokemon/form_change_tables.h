...
static const struct FormChange sCharizardFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CHARIZARD_MEGA_Z, ITEM_CHARIZARDITE_Z},
#endif
#if P_GIGANTAMAX_FORMS
...
{
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_COSPLAY,   ITEM_COSTUME_CASE, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_ROCK_STAR, ITEM_COSTUME_CASE, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_POP_STAR,  ITEM_COSTUME_CASE, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_BELLE,     ITEM_COSTUME_CASE, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_PHD,       ITEM_COSTUME_CASE, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PIKACHU_LIBRE,     ITEM_COSTUME_CASE, 5},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sCastformMegaFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_MEGA_SUNNY, B_WEATHER_SUN, ABILITY_WEATHERMAN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_MEGA_RAINY, B_WEATHER_RAIN, ABILITY_WEATHERMAN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_MEGA_SNOWY, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_WEATHERMAN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_MEGA, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_WEATHERMAN},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_MEGA, B_WEATHER_NONE, ABILITY_WEATHERMAN},
    {FORM_CHANGE_BATTLE_SWITCH_OUT, SPECIES_CASTFORM_MEGA},
    {FORM_CHANGE_FAINT,             SPECIES_CASTFORM_NORMAL},
    {FORM_CHANGE_END_BATTLE,        SPECIES_CASTFORM_NORMAL},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sRotomFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_ROTOM_STEREO,    ITEM_ROTOM_CATALOG, 6},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,   SPECIES_AVITORCH_ENRAGED,   ABILITY_PUNISHER, DAMAGE_CATEGORY_PHYSICAL},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,   SPECIES_AVITORCH_ENRAGED,   ABILITY_PUNISHER, DAMAGE_CATEGORY_SPECIAL},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,             SPECIES_AVITORCH},
