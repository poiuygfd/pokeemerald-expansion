...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_STRAWB_BERRY - FIRST_BERRY_INDEX]           = sPicTable_RazzBerryTree,
    [ITEM_PEAPEE_BERRY - FIRST_BERRY_INDEX]           = sPicTable_MicleBerryTree,
...
const u8 *const gBerryTreePaletteSlotTablePointers[] = {
    ...
    [ITEM_STRAWB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Razz,
    [ITEM_PEAPEE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Micle,
