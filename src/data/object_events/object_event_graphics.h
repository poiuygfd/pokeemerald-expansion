...
const u32 gObjectEventPic_EmeraldBrendanNormal[] = INCBIN_U32("graphics/object_events/pics/people/emerald_brendan/walking.png", ".4bpp", "-mwidth 2 -mheight 4");
...
const u16 gObjectEventPal_EmeraldBrendan[] = INCBIN_U16("graphics/object_events/palettes/emerald_brendan.pal", ".gbapal");
