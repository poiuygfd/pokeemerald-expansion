...
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_ACRO_BIKE   OBJ_EVENT_GFX_RS_BRENDAN_ACRO_BIKE
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_SURFING     OBJ_EVENT_GFX_RS_BRENDAN_SURFING
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_UNDERWATER  OBJ_EVENT_GFX_RS_BRENDAN_UNDERWATER
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_FIELD_MOVE  OBJ_EVENT_GFX_RS_BRENDAN_FIELD_MOVE
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_FISHING     OBJ_EVENT_GFX_RS_BRENDAN_FISHING
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_WATERING    OBJ_EVENT_GFX_RS_BRENDAN_WATERING
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_DECORATING  OBJ_EVENT_GFX_RS_BRENDAN_DECORATING
#define OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_FIELD_MOVE  OBJ_EVENT_GFX_RS_BRENDAN_FIELD_MOVE

#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_NORMAL          OBJ_EVENT_GFX_LINK_RS_MAY
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_ACRO_BIKE       OBJ_EVENT_GFX_RS_MAY_ACRO_BIKE
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_SURFING         OBJ_EVENT_GFX_RS_MAY_SURFING
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_UNDERWATER      OBJ_EVENT_GFX_RS_MAY_UNDERWATER
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_FIELD_MOVE      OBJ_EVENT_GFX_RS_MAY_FIELD_MOVE
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_FISHING         OBJ_EVENT_GFX_RS_MAY_FISHING
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_WATERING        OBJ_EVENT_GFX_RS_MAY_WATERING
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_DECORATING      OBJ_EVENT_GFX_RS_MAY_DECORATING
#define OBJ_EVENT_GFX_OUTFIT_RS_MAY_FIELD_MOVE      OBJ_EVENT_GFX_RS_MAY_FIELD_MOVE

#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_NORMAL       OBJ_EVENT_GFX_LINK_E_BRENDAN
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_ACRO_BIKE    OBJ_EVENT_GFX_E_BRENDAN_ACRO_BIKE
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_SURFING      OBJ_EVENT_GFX_E_BRENDAN_SURFING
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_UNDERWATER   OBJ_EVENT_GFX_E_BRENDAN_UNDERWATER
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_FIELD_MOVE   OBJ_EVENT_GFX_E_BRENDAN_FIELD_MOVE
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_FISHING      OBJ_EVENT_GFX_E_BRENDAN_FISHING
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_WATERING     OBJ_EVENT_GFX_E_BRENDAN_WATERING
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_DECORATING   OBJ_EVENT_GFX_E_BRENDAN_DECORATING
#define OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_FIELD_MOVE   OBJ_EVENT_GFX_E_BRENDAN_FIELD_MOVE

#define OBJ_EVENT_GFX_OUTFIT_E_MAY_NORMAL           OBJ_EVENT_GFX_LINK_E_MAY
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_ACRO_BIKE        OBJ_EVENT_GFX_E_MAY_ACRO_BIKE
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_SURFING          OBJ_EVENT_GFX_E_MAY_SURFING
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_UNDERWATER       OBJ_EVENT_GFX_E_MAY_UNDERWATER
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_FIELD_MOVE       OBJ_EVENT_GFX_E_MAY_FIELD_MOVE
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_FISHING          OBJ_EVENT_GFX_E_MAY_FISHING
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_WATERING         OBJ_EVENT_GFX_E_MAY_WATERING
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_DECORATING       OBJ_EVENT_GFX_E_MAY_DECORATING
#define OBJ_EVENT_GFX_OUTFIT_E_MAY_FIELD_MOVE       OBJ_EVENT_GFX_E_MAY_FIELD_MOVE
...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_MAGICAL_BLUE] = {
        ...
        .trainerPicMale = TRAINER_PIC_BRENDAN,
        .trainerPicFemale = TRAINER_PIC_MAY,
        /*.trainerPics = {
    ...
    [OUTFIT_RUBY_RED] = {
        ...
        #endif
        .trainerPicMale = TRAINER_PIC_RS_BRENDAN,
        .trainerPicFemale = TRAINER_PIC_RS_MAY,
        /*.trainerPics = {
    ...
    [OUTFIT_EMERALD_GREEN] = {
        ...
        #endif
        .trainerPicMale = TRAINER_PIC_E_BRENDAN,
        .trainerPicFemale = TRAINER_PIC_E_MAY,
        /*.trainerPics = {
