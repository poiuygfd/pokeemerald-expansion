...
static const u8 sText_OutfitName_KantoCosplay[] = _("KANTO COSPLAY"),
static const u8 sText_OutfitDesc_KantoCosplay[] = _(
    "A cosplay costume resembling\na battle legend's outfit."),
#endif
...
static const u8 sFrontierPassPlayerIcons_RedLeaf_Gfx[] = INCBIN_U8("graphics/frontier_pass/map_heads.4bpp");
...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_MAGICAL_BLUE] = {
        ...
        .avatarGfxIds = {
           [MALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
           ...
           [FEMALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_MAY_ACRO_BIKE,
    ...
    [OUTFIT_RUBY_RED] = {
        ...
        .avatarGfxIds = {
           [MALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_OUTFIT_RS_BRENDAN_ACRO_BIKE,
           ...
           [FEMALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_OUTFIT_RS_MAY_ACRO_BIKE,
    ...
    [OUTFIT_EMERALD_GREEN] = {
        ...
        .avatarGfxIds = {
           [MALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_ACRO_BIKE,
               [PLAYER_AVATAR_STATE_ACRO_BIKE] =  OBJ_EVENT_GFX_OUTFIT_E_BRENDAN_ACRO_BIKE,
           ...
           [FEMALE] = {
               ...
               [PLAYER_AVATAR_STATE_MACH_BIKE] =  OBJ_EVENT_GFX_OUTFIT_E_MAY_ACRO_BIKE,
               [PLAYER_AVATAR_STATE_ACRO_BIKE] =  OBJ_EVENT_GFX_OUTFIT_E_MAY_ACRO_BIKE,
    ...
    [OUTFIT_KANTO_COSPLAY] = {
        .isHidden = FALSE,
        .prices = { 200, 500 },
        #if MODERN == 1
        .name = COMPOUND_STRING("KANTO COSPLAY"),
        .desc = COMPOUND_STRING("A cosplay costume resembling\na battle legend's outfit."),
        #else
        .name = sText_OutfitName_KantoCosplay,
        .desc = sText_OutfitDesc_KantoCosplay,
        #endif
        .trainerPics = {
        ...
        .iconsFP = sFrontierPassPlayerIcons_RedLeaf_Gfx,
    },
};
