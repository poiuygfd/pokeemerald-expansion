...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_HAD_NO_EFFECT]          = COMPOUND_STRING("It had no effect."),
};
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_COSTUME_ROCK]    = {COMPOUND_STRING("Rock costume"),    CursorCb_CostumeRock},
    [MENU_COSTUME_POP]     = {COMPOUND_STRING("Pop costume"),     CursorCb_CostumePop},
    [MENU_COSTUME_BELLE]   = {COMPOUND_STRING("Belle costume"),   CursorCb_CostumeBelle},
    [MENU_COSTUME_PHD]     = {COMPOUND_STRING("Ph.D. costume"),   CursorCb_CostumePhd},
    [MENU_COSTUME_LIBRE]   = {COMPOUND_STRING("Libre costume"),   CursorCb_CostumeLibre},
};
