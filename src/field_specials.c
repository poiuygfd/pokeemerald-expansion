...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_MEGA_STONE_VENDOR] =
    {
        ...
        COMPOUND_STRING("MEGANIUMITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("FERALIGITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("EMBOARITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("PINSIRITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("HERACRONITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("ALAKAZITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("STARMINITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SLOWBRONITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GARDEVOIRITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GALLADITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("CHANDELURITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("LUCARIONITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("LUCARIONITE Z{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GLIMMORANITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("RAICHUNITE X{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("RAICHUNITE Y{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GOLISOPITE{CLEAR_TO 0x5E}32BP"),
