...
static void LotteryCornerComputerEffect(struct Task *task)
{
    if (task->tTimer == 6)
    {
        ...
        {
            // Screen is on, set it off
            MapGridSetMetatileIdAt(12 + MAP_OFFSET, 1 + MAP_OFFSET, METATILE_Shop_Laptop1_Normal | MAPGRID_IMPASSABLE);
            MapGridSetMetatileIdAt(12 + MAP_OFFSET, 2 + MAP_OFFSET, METATILE_Shop_Laptop2_Normal | MAPGRID_IMPASSABLE);
        }
        else
        {
            // Screen is off, set it on
            MapGridSetMetatileIdAt(12 + MAP_OFFSET, 1 + MAP_OFFSET, METATILE_Shop_Laptop1_Flash | MAPGRID_IMPASSABLE);
            MapGridSetMetatileIdAt(12 + MAP_OFFSET, 2 + MAP_OFFSET, METATILE_Shop_Laptop2_Flash | MAPGRID_IMPASSABLE);
        }
        DrawWholeMapView();
...
bool8 UsedPokemonCenterWarp(void)
{
    static const u16 sPokemonCenters[] =
    {
        ...
        MAP_TUFFNOOK_TOWN_POKEMON_CENTER_1F,
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("AIR BALLOON{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("SHELL BELL{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("ABILITY SHIELD{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("SCOPE LENS{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("EXPERT BELT{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("FLAME ORB{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("TOXIC ORB{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("WEAKNESS POLICY{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("BLUNDER POLICY{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("FOCUS BAND{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("FOCUS SASH{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("THROAT SPRAY{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("LIGHT CLAY{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("TERRAIN EXTENDER{CLEAR_TO 94}24BP"),
        ...
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("LIFE ORB{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("CLEAR AMULET{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("COVERT CLOAK{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("ROCKY HELMET{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("ASSAULT VEST{CLEAR_TO 94}32BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR] =
    {
        COMPOUND_STRING("KISS POSTER{CLEAR_TO 88}16BP"),
        COMPOUND_STRING("KISS CUSHION{CLEAR_TO 88}16BP"),
        COMPOUND_STRING("SMOOCHUM DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("TOGEPI DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("WOOPER DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("MEOWTH DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("CLEFAIRY DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("LOTAD DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("SEEDOT DOLL{CLEAR_TO 88}24BP"),
        COMPOUND_STRING("CHIKORITA DOLL{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("CYNDAQUIL DOLL{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("TOTODILE DOLL{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("DITTO DOLL{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("PORYGON2 DOLL{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("LAPRAS DOLL{CLEAR_TO 88}40BP"),
        COMPOUND_STRING("SNORLAX DOLL{CLEAR_TO 88}40BP"),
        COMPOUND_STRING("VENUSAUR DOLL{CLEAR_TO 88}48BP"),
        COMPOUND_STRING("CHARIZARD DOLL{CLEAR_TO 88}48BP"),
        COMPOUND_STRING("BLASTOISE DOLL{CLEAR_TO 88}48BP"),
        COMPOUND_STRING("REGIROCK DOLL{CLEAR_TO 88}56BP"),
        COMPOUND_STRING("REGICE DOLL{CLEAR_TO 88}56BP"),
        COMPOUND_STRING("REGISTEEL DOLL{CLEAR_TO 88}56BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_EVOLUTION_VENDOR] =
    {
        COMPOUND_STRING("EVERSTONE{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("LINKING CORD{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("UPGRADE{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("DUBIOUS DISC{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("AUSPICIOUS ARMOR{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("MALICIOUS ARMOR{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("RAZOR FANG{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("WHIPPED DREAM{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("PRISM SCALE{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("REAPER CLOTH{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("GALARICA CUFF{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("GALARICA WREATH{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("PROTECTOR{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("DEEP SEA TOOTH{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("DEEP SEA SCALE{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("DRAGON SCALE{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("LEADER'S CREST{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("METAL COAT{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("BLACK AUGURITE{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("PEAT BLOCK{CLEAR_TO 94}24BP"),
        COMPOUND_STRING("METAL ALLOY{CLEAR_TO 94}24BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_MEGA_STONE_VENDOR] =
    {
        COMPOUND_STRING("VENUSAURITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("CHARIZARDITE X{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("CHARIZARDITE Y{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("BLASTOISINITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("MEGANIUMITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("FERALIGITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("EMBOARITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("PINSIRITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("HERACRONITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("ALAKAZITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("STARMINITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("SLOWBRONITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("GARDEVOIRITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("GALLADITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("CHANDELURITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("LUCARIONITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("LUCARIONITE Z{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("GLIMMORANITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("RAICHUNITE X{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("RAICHUNITE Y{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("GOLISOPITE{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("MEWTWONITE X{CLEAR_TO 88}32BP"),
        COMPOUND_STRING("MEWTWONITE Y{CLEAR_TO 88}32BP"),
        gText_Exit
    },
    ...
    [SCROLL_MULTI_BF_MOVE_TUTOR_1] =
    {
        ...
        COMPOUND_STRING("DREAM EATER{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("SWIFT{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("SEISMIC TOSS{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("WISH{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("COUNTER{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("STEALTH ROCK{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("GYRO BALL{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("MEGA PUNCH{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("MEGA KICK{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("ICE PUNCH{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("THUNDER PUNCH{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("FIRE PUNCH{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("ICY WIND{CLEAR_TO 78}32BP"),
    ...
    {
        COMPOUND_STRING("SNORE{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("MUD-SLAP{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("ENDURE{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("ICE FANG{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("THUNDER FANG{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("FIRE FANG{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("SIGNAL BEAM{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("PSYCH UP{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("AURORA VEIL{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("BULLDOZE{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("SOFTBOILED{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("BODY SLAM{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("ROCK SLIDE{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("THUNDER WAVE{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("SWORDS DANCE{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("LIQUIDATION{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("METEOR BEAM{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("TRIPLE AXEL{CLEAR_TO 78}32BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_3] =
    {
        COMPOUND_STRING("SPLISH SPLASH{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("FLOATY FALL{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("BOUNCY BUBBLE{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("BUZZY BUZZ{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("SIZZLY SLIDE{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("GLITZY GLOW{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("BADDY BAD{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("ZIPPY ZAP{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("VOLT TACKLE{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("PIKA PAPOW{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("SAPPY SEED{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("FREEZY FROST{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("SPARKLY SWIRL{CLEAR_TO 78}32BP"),
        COMPOUND_STRING("VEEVEE VOLLEY{CLEAR_TO 78}32BP"),
        gText_Exit
    },
...
u32 GetMartEmployeeObjectEventId(void)
{
    static const u8 sPokeMarts[][3] =
    {
        ...
        { MAP_GROUP(MAP_TUFFNOOK_TOWN_MART),   MAP_NUM(MAP_TUFFNOOK_TOWN_MART),   LOCALID_TUFFNOOK_MART_CLERK },
