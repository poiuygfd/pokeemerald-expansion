        ...
        if (myLinkPlayerNumber != i)
        {
            ...
            case VERSION_SAPPHIRE:
                if (gLinkPlayers[i].gender == 0)
                    linkSpriteId = OBJ_EVENT_GFX_RS_BRENDAN_NORMAL;
                else
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("AIR BALLOON{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("SHELL BELL{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("ABILITY SHIELD{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("SCOPE LENS{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("EXPERT BELT{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("FLAME ORB{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("TOXIC ORB{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("WEAKNESS POLICY{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("BLUNDER POLICY{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("FOCUS BAND{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("FOCUS SASH{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("THROAT SPRAY{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("LIGHT CLAY{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("TERRAIN EXTENDER{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("EVIOLITE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("HEAVY DUTY BOOTS{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("LOADED DICE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("CHOICE BAND{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("CHOICE SPECS{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("CHOICE SCARF{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("LIFE ORB{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("CLEAR AMULET{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("COVERT CLOAK{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("ROCKY HELMET{CLEAR_TO 0x64}32BP"),
        COMPOUND_STRING("ASSAULT VEST{CLEAR_TO 0x64}32BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR] =
    {
        ...
        COMPOUND_STRING("LOTAD DOLL{CLEAR_TO 0x5E}24BP"),
        ...
        COMPOUND_STRING("LAPRAS DOLL{CLEAR_TO 0x5E}40BP"),
        COMPOUND_STRING("SNORLAX DOLL{CLEAR_TO 0x5E}40BP"),
        COMPOUND_STRING("VENUSAUR DOLL{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("CHARIZARD DOLL{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("BLASTOISE DOLL{CLEAR_TO 0x5E}48BP"),
        COMPOUND_STRING("REGIROCK DOLL{CLEAR_TO 0x5E}56BP"),
        COMPOUND_STRING("REGICE DOLL{CLEAR_TO 0x5E}56BP"),
        COMPOUND_STRING("REGISTEEL DOLL{CLEAR_TO 0x5E}56BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_EVOLUTION_VENDOR] =
    {
        COMPOUND_STRING("EVERSTONE{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("LINKING CORD{CLEAR_TO 0x64}16BP"),
        COMPOUND_STRING("UPGRADE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("DUBIOUS DISC{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("AUSPICIOUS ARMOR{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("MALICIOUS ARMOR{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("RAZOR FANG{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("WHIPPED DREAM{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("PRISM SCALE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("REAPER CLOTH{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("GALARICA CUFF{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("GALARICA WREATH{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("PROTECTOR{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("DEEP SEA TOOTH{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("DEEP SEA SCALE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("DRAGON SCALE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("LEADER'S CREST{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("METAL COAT{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("BLACK AUGURITE{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("PEAT BLOCK{CLEAR_TO 0x64}24BP"),
        COMPOUND_STRING("METAL ALLOY{CLEAR_TO 0x64}24BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_MEGA_STONE_VENDOR] =
    {
        COMPOUND_STRING("VENUSAURITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("CHARIZARDITE X{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("CHARIZARDITE Y{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("BLASTOISINITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("BEEDRILLITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GENGARITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("MEWTWONITE X{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("MEWTWONITE Y{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("STEELIXITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SCIZORITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("HOUNDOOMITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("TYRANITARITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SCEPTILITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("BLAZIKENITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SWAMPERTITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("SALAMENCITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("METAGROSSITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("LATIASITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("LATIOSITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("GARCHOMPITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("ABOMASITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("AUDINITE{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("DIANCITE{CLEAR_TO 0x5E}32BP"),
        gText_Exit
    },
