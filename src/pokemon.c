...
static const enum NationalDexOrder sKantoToNationalOrder[KANTO_DEX_COUNT] =
{
    ...
    KANTO_TO_NATIONAL(ROCKRUFF),
    KANTO_TO_NATIONAL(LYCANROC),
    KANTO_TO_NATIONAL(MANKEY),
    KANTO_TO_NATIONAL(PRIMEAPE),
    KANTO_TO_NATIONAL(ANNIHILAPE),
    KANTO_TO_NATIONAL(WOOLOO),
    KANTO_TO_NATIONAL(DUBWOOL),
    ...
    KANTO_TO_NATIONAL(TAROUNTULA),
    KANTO_TO_NATIONAL(SPIDOPS),
    KANTO_TO_NATIONAL(NYMBLE),
    KANTO_TO_NATIONAL(LOKIX),
    KANTO_TO_NATIONAL(HOOTHOOT),
    KANTO_TO_NATIONAL(NOCTOWL),
    KANTO_TO_NATIONAL(SHROOMISH),
    KANTO_TO_NATIONAL(BRELOOM),
    KANTO_TO_NATIONAL(PHANTUMP),
    KANTO_TO_NATIONAL(TREVENANT),
    ...
    KANTO_TO_NATIONAL(YAMPER),
    KANTO_TO_NATIONAL(BOLTUND),
    KANTO_TO_NATIONAL(SKITTY),
    KANTO_TO_NATIONAL(DELCATTY),
    KANTO_TO_NATIONAL(MINCCINO),
    KANTO_TO_NATIONAL(CINCCINO),
    KANTO_TO_NATIONAL(ZUBAT),
    KANTO_TO_NATIONAL(GOLBAT),
    KANTO_TO_NATIONAL(CROBAT),
    KANTO_TO_NATIONAL(NOIBAT),
    KANTO_TO_NATIONAL(NOIVERN),
    KANTO_TO_NATIONAL(GEODUDE),
    KANTO_TO_NATIONAL(GRAVELER),
    KANTO_TO_NATIONAL(GOLEM),
    KANTO_TO_NATIONAL(MIENFOO),
    KANTO_TO_NATIONAL(MIENSHAO),
    KANTO_TO_NATIONAL(SANDSHREW),
    KANTO_TO_NATIONAL(SANDSLASH),
    KANTO_TO_NATIONAL(PARAS),
    KANTO_TO_NATIONAL(PARASECT),
    KANTO_TO_NATIONAL(MORELULL),
    KANTO_TO_NATIONAL(SHIINOTIC),
    KANTO_TO_NATIONAL(FERROSEED),
    KANTO_TO_NATIONAL(FERROTHORN),
    KANTO_TO_NATIONAL(CLEFFA),
    KANTO_TO_NATIONAL(CLEFAIRY),
    KANTO_TO_NATIONAL(CLEFABLE),
    KANTO_TO_NATIONAL(ROOKIDEE),
    KANTO_TO_NATIONAL(CORVISQUIRE),
    KANTO_TO_NATIONAL(CORVIKNIGHT),
    KANTO_TO_NATIONAL(EKANS),
    KANTO_TO_NATIONAL(ARBOK),
    KANTO_TO_NATIONAL(SALANDIT),
    KANTO_TO_NATIONAL(SALAZZLE),
    KANTO_TO_NATIONAL(RUFFLET),
    KANTO_TO_NATIONAL(BRAVIARY),
    ...
    KANTO_TO_NATIONAL(CHEWTLE),
    KANTO_TO_NATIONAL(DREDNAW),
    KANTO_TO_NATIONAL(MEOWTH),
    KANTO_TO_NATIONAL(PERSIAN),
    KANTO_TO_NATIONAL(PERRSERKER),
    KANTO_TO_NATIONAL(TANDEMAUS),
    KANTO_TO_NATIONAL(MAUSHOLD),
    ...
    KANTO_TO_NATIONAL(ESPURR),
    KANTO_TO_NATIONAL(MEOWSTIC),
    KANTO_TO_NATIONAL(RIOLU),
    KANTO_TO_NATIONAL(LUCARIO),
    KANTO_TO_NATIONAL(BOUNSWEET),
    KANTO_TO_NATIONAL(STEENEE),
    KANTO_TO_NATIONAL(TSAREENA),
    ...
    KANTO_TO_NATIONAL(PAWMI),
    KANTO_TO_NATIONAL(PAWMO),
    KANTO_TO_NATIONAL(PAWMOT),
    KANTO_TO_NATIONAL(CUTIEFLY),
    KANTO_TO_NATIONAL(RIBOMBEE),
    KANTO_TO_NATIONAL(DIGLETT),
    KANTO_TO_NATIONAL(DUGTRIO),
    KANTO_TO_NATIONAL(DRILBUR),
    KANTO_TO_NATIONAL(EXCADRILL),
    ...
    KANTO_TO_NATIONAL(CUFANT),
    KANTO_TO_NATIONAL(COPPERAJAH),
    KANTO_TO_NATIONAL(SABLEYE),
    KANTO_TO_NATIONAL(GLIMMET),
    KANTO_TO_NATIONAL(GLIMMORA),
    KANTO_TO_NATIONAL(THROH),
    KANTO_TO_NATIONAL(SAWK),
    KANTO_TO_NATIONAL(ONIX),
    KANTO_TO_NATIONAL(STEELIX),
    KANTO_TO_NATIONAL(AXEW),
    KANTO_TO_NATIONAL(FRAXURE),
    KANTO_TO_NATIONAL(HAXORUS),
    KANTO_TO_NATIONAL(GASTLY),
    KANTO_TO_NATIONAL(HAUNTER),
    KANTO_TO_NATIONAL(GENGAR),
    KANTO_TO_NATIONAL(SINISTEA),
    KANTO_TO_NATIONAL(POLTEAGEIST),
    KANTO_TO_NATIONAL(GOTHITA),
    KANTO_TO_NATIONAL(GOTHORITA),
    KANTO_TO_NATIONAL(GOTHITELLE),
    KANTO_TO_NATIONAL(IMPIDIMP),
    KANTO_TO_NATIONAL(MORGREM),
    KANTO_TO_NATIONAL(GRIMMSNARL),
    KANTO_TO_NATIONAL(CUBONE),
    KANTO_TO_NATIONAL(MAROWAK),
    KANTO_TO_NATIONAL(LITWICK),
    KANTO_TO_NATIONAL(LAMPENT),
    KANTO_TO_NATIONAL(CHANDELURE),
    KANTO_TO_NATIONAL(SIGILYPH),
    KANTO_TO_NATIONAL(SMOLIV),
    KANTO_TO_NATIONAL(DOLLIV),
    KANTO_TO_NATIONAL(ARBOLIVA),
    KANTO_TO_NATIONAL(SEEDOT),
    KANTO_TO_NATIONAL(NUZLEAF),
    KANTO_TO_NATIONAL(SHIFTRY),
    KANTO_TO_NATIONAL(GROWLITHE),
    KANTO_TO_NATIONAL(ARCANINE),
    KANTO_TO_NATIONAL(VULPIX),
    KANTO_TO_NATIONAL(NINETALES),
    KANTO_TO_NATIONAL(COMBEE),
    KANTO_TO_NATIONAL(VESPIQUEN),
    KANTO_TO_NATIONAL(FOONGUS),
    KANTO_TO_NATIONAL(AMOONGUSS),
    KANTO_TO_NATIONAL(VAROOM),
    KANTO_TO_NATIONAL(REVAVROOM),
    ...
    KANTO_TO_NATIONAL(TOXEL),
    KANTO_TO_NATIONAL(TOXTRICITY),
    KANTO_TO_NATIONAL(FARFETCHD),
    KANTO_TO_NATIONAL(SIRFETCHD),
    KANTO_TO_NATIONAL(AUDINO),
    KANTO_TO_NATIONAL(VENIPEDE),
    KANTO_TO_NATIONAL(WHIRLIPEDE),
    KANTO_TO_NATIONAL(SCOLIPEDE),
    KANTO_TO_NATIONAL(WIMPOD),
    KANTO_TO_NATIONAL(GOLISOPOD),
    KANTO_TO_NATIONAL(DITTO),
    KANTO_TO_NATIONAL(SANDYGAST),
    KANTO_TO_NATIONAL(PALOSSAND),
    KANTO_TO_NATIONAL(LITLEO),
    KANTO_TO_NATIONAL(PYROAR),
    KANTO_TO_NATIONAL(SPRITZEE),
    KANTO_TO_NATIONAL(AROMATISSE),
    KANTO_TO_NATIONAL(SPOINK),
    KANTO_TO_NATIONAL(GRUMPIG),
    KANTO_TO_NATIONAL(PETILIL),
    KANTO_TO_NATIONAL(LILLIGANT),
    KANTO_TO_NATIONAL(SURSKIT),
    KANTO_TO_NATIONAL(MASQUERAIN),
    KANTO_TO_NATIONAL(DEWPIDER),
    KANTO_TO_NATIONAL(ARAQUANID),
    KANTO_TO_NATIONAL(DODUO),
    KANTO_TO_NATIONAL(DODRIO),
    KANTO_TO_NATIONAL(MILCERY),
    KANTO_TO_NATIONAL(ALCREMIE),
    KANTO_TO_NATIONAL(FURFROU),
    KANTO_TO_NATIONAL(MUDBRAY),
    KANTO_TO_NATIONAL(MUDSDALE),
    KANTO_TO_NATIONAL(PONYTA),
    KANTO_TO_NATIONAL(RAPIDASH),
    KANTO_TO_NATIONAL(FALINKS),
    KANTO_TO_NATIONAL(FLABEBE),
    KANTO_TO_NATIONAL(FLOETTE),
    KANTO_TO_NATIONAL(FLORGES),
    KANTO_TO_NATIONAL(KOMALA),
    KANTO_TO_NATIONAL(SPINDA),
    KANTO_TO_NATIONAL(PINECO),
    KANTO_TO_NATIONAL(FORRETRESS),
    KANTO_TO_NATIONAL(ABSOL),
    ...
    KANTO_TO_NATIONAL(ARROKUDA),
    KANTO_TO_NATIONAL(BARRASKEWDA),
    KANTO_TO_NATIONAL(GOLDEEN),
    KANTO_TO_NATIONAL(SEAKING),
    KANTO_TO_NATIONAL(QWILFISH),
    KANTO_TO_NATIONAL(OVERQWIL),
    KANTO_TO_NATIONAL(KRABBY),
    KANTO_TO_NATIONAL(KINGLER),
    KANTO_TO_NATIONAL(CORPHISH),
    KANTO_TO_NATIONAL(CRAWDAUNT),
    KANTO_TO_NATIONAL(SHELLOS),
    KANTO_TO_NATIONAL(GASTRODON),
    KANTO_TO_NATIONAL(SHELLDER),
    KANTO_TO_NATIONAL(CLOYSTER),
    KANTO_TO_NATIONAL(REMORAID),
    KANTO_TO_NATIONAL(OCTILLERY),
    KANTO_TO_NATIONAL(STARYU),
    KANTO_TO_NATIONAL(STARMIE),
    KANTO_TO_NATIONAL(INKAY),
    KANTO_TO_NATIONAL(MALAMAR),
    KANTO_TO_NATIONAL(TYNAMO),
    KANTO_TO_NATIONAL(EELEKTRIK),
    KANTO_TO_NATIONAL(EELEKTROSS),
    KANTO_TO_NATIONAL(SKRELP),
    KANTO_TO_NATIONAL(DRAGALGE),
    KANTO_TO_NATIONAL(HORSEA),
    KANTO_TO_NATIONAL(SEADRA),
    KANTO_TO_NATIONAL(KINGDRA),
    KANTO_TO_NATIONAL(LUVDISC),
    ...
    KANTO_TO_NATIONAL(FLAMIGO),
    KANTO_TO_NATIONAL(WIGLETT),
    KANTO_TO_NATIONAL(WUGTRIO),
    KANTO_TO_NATIONAL(POLTCHAGEIST),
    KANTO_TO_NATIONAL(SINISTCHA),
    KANTO_TO_NATIONAL(TOEDSCOOL),
    KANTO_TO_NATIONAL(TOEDSCRUEL),
    ...
    KANTO_TO_NATIONAL(TADBULB),
    KANTO_TO_NATIONAL(BELLIBOLT),
    KANTO_TO_NATIONAL(SMOOCHUM),
    KANTO_TO_NATIONAL(JYNX),
    KANTO_TO_NATIONAL(SNOM),
    KANTO_TO_NATIONAL(FROSMOTH),
    ...
    KANTO_TO_NATIONAL(CETODDLE),
    KANTO_TO_NATIONAL(CETITAN),
    KANTO_TO_NATIONAL(EISCUE),
    ...
    KANTO_TO_NATIONAL(MIMIKYU),
    KANTO_TO_NATIONAL(BRONZOR),
    KANTO_TO_NATIONAL(BRONZONG),
    KANTO_TO_NATIONAL(CHARCADET),
    KANTO_TO_NATIONAL(DARUMAKA),
    KANTO_TO_NATIONAL(DARMANITAN),
    KANTO_TO_NATIONAL(MISSINGNO),
    ...
    KANTO_TO_NATIONAL(DRUDDIGON),
    KANTO_TO_NATIONAL(DRATINI),
    KANTO_TO_NATIONAL(DRAGONAIR),
    KANTO_TO_NATIONAL(DRAGONITE),
    KANTO_TO_NATIONAL(FRIGIBAX),
    KANTO_TO_NATIONAL(ARCTIBAX),
    KANTO_TO_NATIONAL(BAXCALIBUR),
    KANTO_TO_NATIONAL(LARVITAR),
    KANTO_TO_NATIONAL(PUPITAR),
    KANTO_TO_NATIONAL(TYRANITAR),
    KANTO_TO_NATIONAL(DEINO),
    KANTO_TO_NATIONAL(ZWEILOUS),
    KANTO_TO_NATIONAL(HYDREIGON),
    ...
    KANTO_TO_NATIONAL(MELTAN),
    KANTO_TO_NATIONAL(MELMETAL),
    //Post-Game Only Mons
    ...
    KANTO_TO_NATIONAL(SNIVY),
    KANTO_TO_NATIONAL(SERVINE),
    KANTO_TO_NATIONAL(SERPERIOR),
    KANTO_TO_NATIONAL(TEPIG),
    KANTO_TO_NATIONAL(PIGNITE),
    KANTO_TO_NATIONAL(EMBOAR),
    KANTO_TO_NATIONAL(OSHAWOTT),
    KANTO_TO_NATIONAL(DEWOTT),
    KANTO_TO_NATIONAL(SAMUROTT),
    KANTO_TO_NATIONAL(TOGEPI),
    KANTO_TO_NATIONAL(TOGETIC),
    KANTO_TO_NATIONAL(TOGEKISS),
    KANTO_TO_NATIONAL(ROGGENROLA),
    KANTO_TO_NATIONAL(BOLDORE),
    KANTO_TO_NATIONAL(GIGALITH),
    KANTO_TO_NATIONAL(GOLETT),
    KANTO_TO_NATIONAL(GOLURK),
    KANTO_TO_NATIONAL(UNOWN),
    KANTO_TO_NATIONAL(DREEPY),
    KANTO_TO_NATIONAL(DRAKLOAK),
    KANTO_TO_NATIONAL(DRAGAPULT),
    KANTO_TO_NATIONAL(MAGEARNA),
    KANTO_TO_NATIONAL(KUBFU),
    KANTO_TO_NATIONAL(URSHIFU),
    KANTO_TO_NATIONAL(CRESSELIA),
    KANTO_TO_NATIONAL(DARKRAI),
    KANTO_TO_NATIONAL(XERNEAS),
    KANTO_TO_NATIONAL(YVELTAL),
    KANTO_TO_NATIONAL(ZYGARDE),
...
static const enum NationalDexOrder sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    //Bonus mons, do not count towards dex completion
    HOENN_TO_NATIONAL(AVITORCH),
    HOENN_TO_NATIONAL(PARTRIO),
};
