...
static const struct WindowTemplate sKantoTutorialBattleWindowTemplates[] =
{
    [B_WIN_MSG] = {
        .bg = 0,
        .tilemapLeft = 2,
...
const struct WindowTemplate *const gBattleWindowTemplates[] =
{
    ...
    [B_WIN_TYPE_KANTO_TUTORIAL] = sKantoTutorialBattleWindowTemplates,
};
