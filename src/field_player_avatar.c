...
static const u8 sPlayerEmeraldAvatarGfxIds[][GENDER_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_E_BRENDAN_NORMAL,     OBJ_EVENT_GFX_E_MAY_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_E_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_E_MAY_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_E_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_E_MAY_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_E_BRENDAN_SURFING,    OBJ_EVENT_GFX_E_MAY_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,   OBJ_EVENT_GFX_MAY_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_E_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_E_MAY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_E_BRENDAN_FISHING,    OBJ_EVENT_GFX_E_MAY_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_E_BRENDAN_WATERING,   OBJ_EVENT_GFX_E_MAY_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_E_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_E_MAY_FIELD_MOVE},
};

static const u8 sPlayerRubySapphireAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_RS_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RS_MAY_FIELD_MOVE},
};
...
{
    if (VarGet(VAR_PLAYER_OUTFIT) == 0)
        return sPlayerAvatarGfxIds[state][gender];
    else if (VarGet(VAR_PLAYER_OUTFIT) == 1)
        return sPlayerEmeraldAvatarGfxIds[state][gender];
    else if (VarGet(VAR_PLAYER_OUTFIT) == 2)
        return sPlayerRubySapphireAvatarGfxIds[state][gender];
    else
        return sPlayerAvatarGfxIds[state][gender];
}
