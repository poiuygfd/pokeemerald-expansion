...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNLAIDCURSE2]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} put a curse on {B_DEF_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_PKMNANCHORSITSELFWITH]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is anchored in place with its suction cups!"),
    ...
    [STRINGID_THESEAOFFIREDISAPPEARED]              = COMPOUND_STRING("The sea of fire around {B_EFF_TEAM2} team disappeared!"),
    [STRINGID_SWAMPENVELOPEDSIDE]                   = COMPOUND_STRING("A swamp enveloped {B_EFF_TEAM2} team!"),
    [STRINGID_THESWAMPDISAPPEARED]                  = COMPOUND_STRING("The swamp around {B_EFF_TEAM2} team disappeared!"),
    ...
    [STRINGID_REACTEDTOSUPEREFFECTIVE]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} reacted fast to being hit by a super-effective move!"),
    [STRINGID_NEPOTISMPRESENCEOFMONEY]              = COMPOUND_STRING("You sense the presence of money!"),
    [STRINGID_NEPOTISMTRANSFORM]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} transformed into Omega Charizard Z!"),
...
const u16 gStartingStatusStringIds[B_MSG_STARTING_STATUS_COUNT] =
{
    ...
    [B_MSG_TERRAIN_SET_VOID]     = STRINGID_THEVOIDCREEPSIN,
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_VOID] = STRINGID_THEVOIDENDS,
};
