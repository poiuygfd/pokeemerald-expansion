...
const u8 gText_PkmnChangedLeader[] = _("{STR_VAR_1}'s Leader has changed!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NormalTagMatch[] = _("NORMAL MODE");
const u8 gText_ExpertTagMatch[] = _("EXPERT MODE");
const u8 gText_VarietyTagMatch[] = _("MASTER MODE");
const u8 gText_UniqueTagMatch[] = _("UNIQUE MODE");
