...
static const u8 sText_HoldEffectStrawbBerry[] = _("Strawb Berry");
static const u8 sText_HoldEffectPeapeeBerry[] = _("Peapee Berry");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_STRAWB_BERRY] = sText_HoldEffectStrawbBerry,
    [HOLD_EFFECT_PEAPEE_BERRY] = sText_HoldEffectPeapeeBerry,
