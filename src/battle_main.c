...
s32 GetWhichBattlerFasterArgs(struct BattleContext *ctx, bool32 ignoreChosenMoves, u32 speedBattler1, u32 speedBattler2, s32 priority1, s32 priority2)
{
    ...
    if (priority1 == priority2)
    {
        ...
        bool32 battler1HasQuickEffect = gProtectStructs[ctx->battlerAtk].quickDraw || gProtectStructs[ctx->battlerAtk].reactiveFire || gProtectStructs[ctx->battlerAtk].usedCustapBerry;
        bool32 battler2HasQuickEffect = gProtectStructs[ctx->battlerDef].quickDraw || gProtectStructs[ctx->battlerDef].reactiveFire || gProtectStructs[ctx->battlerDef].usedCustapBerry;
