...
static const enum Item sPrizeListElixir1[]     = {ITEM_ABILITY_PATCH,    ITEM_ABILITY_CAPSULE, ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListSunnyDay[]    = {ITEM_ABILITY_PATCH,    ITEM_ABILITY_CAPSULE, ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListElixir2[]     = {ITEM_ABILITY_PATCH,    ITEM_ABILITY_CAPSULE, ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_GREAT_BALL};
static const enum Item sPrizeListBrickBreak[]  = {ITEM_ABILITY_PATCH,    ITEM_ABILITY_CAPSULE, ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_GREAT_BALL};
